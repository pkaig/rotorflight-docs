...
import modesMain from "../img/modes-main.png";
import modes1 from "../img/modes-1.png";
import modesArm from "../img/modes-arm.png";
import modesFlags from "../img/modes-flags.png";
import modesRescue from "../img/modes-rescue.png";
import modes3g from "../img/modes-3g.png";
import modesBlackbox from "../img/modes-blackbox.png";

# Modes

<img src={modesMain} alt="Modes" style={{ maxWidth: '100%' }} />
...
<img src={modes1} alt="Modes" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={modesArm} alt="Modes" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={modesFlags} alt="Modes" style={{ maxWidth: '100%', borderRadius: '10px'}} />
...
<img src={modesRescue} alt="Modes" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
After enabling Rescue mode configure the rescue settings from the [**Profiles**](./profiles.mdx#rescue-settings) Tab.
...
<img src={modes3g} alt="Modes" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
After enabling 3G modes you can configure their settings from the [**Profiles**](./profiles.mdx#auto-leveling-settings) Tab.

## BLACKBOX

When you select [**Normal**](./blackbox.mdx#logging-mode) logging mode, you need to activate the blackbox switch in the Modes Tab.

Enable Blackbox from the tabs. Allocate an AUX channel and range to suit.

<img src={modesBlackbox} alt="Modes" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
